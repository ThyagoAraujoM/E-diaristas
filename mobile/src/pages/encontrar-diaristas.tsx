...
import {
   ...
   ErrorText,
   ResponseContainer,
} from "@styles/pages/encontrar-diaristas.style";
import { useTheme } from "@emotion/react";
import useIndex from "data/hooks/pages/useIndex.pages";
import useEncontrarDiarista from "data/hooks/pages/useEncontrarDiaristas.page.mobile";
   ...
   return (
      <ScrollView>
         <PageTitle
            ...
            subtitle={
               "Preencha seu endereço e veja todos os profissionais da ua localidade"
            }
         />
         <FormContainer>
            <TextInputMask
